...
function PositionSituTanker() {
     ...
     const [isModalVisible, setIsModalVisible] = useState(false);
      ...
      function one() {
        ...
        return <Pie {...config1} style = {{position:"absolute", marginLeft: "60%", width: "500px"}}/>
      }
      ...
      function two() {
        ...
        return <Pie {...config2} style = {{position:"absolute", marginLeft: "60%", width: "500px"}}/>
      }
      ...
      function third() {
        ...
        return <Pie {...config3} style = {{position:"absolute", marginLeft: "60%", width: "500px"}}/>
      }
      ...
      function four() {
        ...
        return <Pie {...config4} style = {{position:"absolute", marginLeft: "60%", width: "500px"}}/>
      }
